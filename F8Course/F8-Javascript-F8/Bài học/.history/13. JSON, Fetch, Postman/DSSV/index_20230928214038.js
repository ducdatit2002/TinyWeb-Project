...
function renderCourses(courses) { 
    var listCorsesBlock = document.querySelector('#list-courses'); var htmls = courses.map(function(course) { return             <li>                 <h4>${course.name}</h4>                 <p>${course.description}</p>             </li>         }); listCorsesBlock.innerHTML = htmls.join("") }
